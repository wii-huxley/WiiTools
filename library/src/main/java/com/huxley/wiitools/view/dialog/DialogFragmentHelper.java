...
public class DialogFragmentHelper {
    ...
    private static final String CUSTOM_TAG = TAG_HEAD + ":interval_insert";
    public static void showCustomDialog(FragmentManager manager, final String title, final View contentView, final IDialogResultListener<Integer> resultListener, final boolean cancelable) {
        CommonDialogFragment dialogFragment = CommonDialogFragment.newInstance(new CommonDialogFragment.OnCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
                AlertDialog.Builder builder = new AlertDialog.Builder(context);
        ...
        dialogFragment.show(manager, CUSTOM_TAG);
    }
}