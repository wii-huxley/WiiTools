...
public class WiiLog {
    ...
    public static String TAG_ROOT = "log_wii";
    ...
    public static void json(int logLevel, String tag, String json) {
        if (LOG) {
            ...
            WiiPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatJson);
        }
    }
    ...
    public static void xml(int logLevel, String tag, String xml) {
        if (LOG) {
            ...
            WiiPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatXml);
        }
    }
    ...
    public static void error(String tag, Throwable throwable) {
        if (LOG) {
            ...
            WiiPrinter.println(Log.ERROR, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatError);
        }
    }
    ...
    private static void msg(int logLevel, String tag, String format, Object... args) {
        if (LOG) {
            ...
            WiiPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatMsg);
        }
    }
