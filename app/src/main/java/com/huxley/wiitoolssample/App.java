...
public class App extends Application {
    ...
    public static class Url{
        public static final UrlBean API_AUTO = new UrlBean("https://dev.accemarket.com/", "api/auth");
    }
